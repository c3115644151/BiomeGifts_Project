...
echo ==========================================
echo      BiomeGifts Plugin Build Script
echo ==========================================
echo.
...
if exist "target\BiomeGifts-1.0-SNAPSHOT.jar" (
    echo [SUCCESS] Jar found at target\BiomeGifts-1.0-SNAPSHOT.jar
    echo Copying to plugins folder...
    copy /Y "target\BiomeGifts-1.0-SNAPSHOT.jar" "..\plugins\BiomeGifts-1.0-SNAPSHOT.jar"
)
echo ==========================================
pause