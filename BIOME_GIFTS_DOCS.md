...
*   **配置结构**:
    *   **Resources (Ores/Crops/Livestock)**: 每个资源定义了 `base_chance` (基础概率) 和对应的掉落物 `drop_item`。
...
| :--- | :--- | :--- | :--- | :--- |
| **奶牛** |
| `FROST_FAT_MILK` | 霜脂牛乳 | 牛奶桶 | 寒冷群系 | 产自寒冷地区的特浓牛奶，表面漂浮着一层厚厚的奶脂。 |
| `CONDENSED_CURD` | 浓缩乳酪 | 牛奶桶 | 炎热群系 | 炎热气候下水分蒸发形成的浓缩奶酪，口感极其厚重。 |
| `ANTIDOTE_MILK` | 解毒清乳 | 牛奶桶 | 雨林/丛林 | 雨林牛食用草药后产出的具有解毒功效的清乳。 |
| `RICH_MILK` | 醇香牛乳 | 牛奶桶 | 所有群系 | 口感醇厚，比普通牛奶更有营养。 |
| **绵羊** |
| `CRYO_FLEECE` | 极地暖绒 | 白色羊毛 | 寒冷群系 | 每一根纤维都像是冰晶拉丝而成，摸上去冰凉刺骨。 |
| `STATIC_WOOL` | 静电硬毛 | 白色羊毛 | 干燥群系 | 干燥环境下充满了静电的硬质羊毛，靠近会有酥麻感。 |
| `SILKY_YARN` | 丝滑柔纱 | 白色羊毛 | 温和群系 | 如同丝绸般顺滑的高级羊毛，泛着珍珠般的光泽。 |
| `SOFT_WOOL` | 柔软羊毛 | 白色羊毛 | 所有群系 | 比普通羊毛更加柔软舒适。 |
| **鸡** |
| `ICE_QUILL` | 冰晶硬羽 | 羽毛 | 寒冷群系 | 坚硬如冰锥的羽毛，极其锋利。 |
| `EMBER_FEATHER` | 余烬飞羽 | 羽毛 | 热带/下界 | 根部似乎还在燃烧的赤红羽毛，带有余温。 |
| `GOLDEN_SHELL_EGG` | 金壳蛋 | 鸡蛋 | 繁茂/平原 | 蛋壳呈现纯金色，拿在手里沉甸甸的。 |
| `FINE_FEATHER` | 优质羽毛 | 羽毛 | 所有群系 | 挑选出的完整羽毛，适合制作工艺品。 |
| **猪** |
| `BLACK_TRUFFLE` | 黑松露 | 棕色蘑菇 | 森林/针叶林 | 散发着浓郁异香的黑色块菌，价比黄金。 |
| `SWAMP_ROOT` | 沼泽药根 | 甜菜根 | 沼泽 | 生长在泥沼深处的扭曲根茎，蕴含着神秘的药性。 |
| `SAND_TUBER` | 沙棘块茎 | 马铃薯 | 沙漠 | 为了在沙漠生存而储存了大量水分的块茎。 |
| `WHITE_TRUFFLE` | 白松露 | 棕色蘑菇 | 所有群系 | 虽然不如黑松露珍贵，但也是不错的食材。 |
